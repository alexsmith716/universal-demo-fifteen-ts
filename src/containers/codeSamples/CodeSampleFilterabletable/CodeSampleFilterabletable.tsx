...
export const CodeSampleFilterabletable = () => {
  ...
  return (
      ...
      <div className="container">
        ...
        <Helmet title="Code Sample Filterabletable" />

        <h1 className="mt-4 mb-3">Component Filterabletable</h1>

        <h4 className="mt-4 mb-3">file: src > components > Filterabletable > Filterabletable.js</h4>
