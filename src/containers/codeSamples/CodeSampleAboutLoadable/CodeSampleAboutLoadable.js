...
const CodeSampleAboutLoadable = () => {

  return (

      <div className="container">

        <Helmet title="Code Sample About Loadable Chunk" />

        <h1 className="mt-4 mb-3">About Loadable</h1>

        <h4 className="mt-4 mb-3">file: src > containers > About > Loadable.js</h4>
...
export default CodeSampleAboutLoadable;
