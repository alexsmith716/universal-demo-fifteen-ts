...
const CodeSampleReduxLineChart = () => {
  ...
  return (
      ...
      <div className="container">
        ...
        <Helmet title="Code Sample Redux LineChart" />

        <h1 className="mt-4 mb-3">Redux Module LineChart</h1>

        <h4 className="mt-4 mb-3">file: src > redux > modules > lineChart.js</h4>
...
// prompt user to do something else (provide a different asset URL) ...
